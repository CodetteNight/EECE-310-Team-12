...
public class MainUI extends JFrame implements Observer, IDisposable {
	...
	private transient IController foodController;
	...
	/**
	 * Provide a given food controller.
	 * @param fc The new food controller.
	 * @return Itself for fluency.
	 */
	public MainUI withFoodController(IController fc) {
		assert fc != null;
		foodController = fc;
		return this;
	}
